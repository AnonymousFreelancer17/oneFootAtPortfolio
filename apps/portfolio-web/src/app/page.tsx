...
export default function Index() {
  ...
  return (
    <div className="w-screen min-h-screen flex flex-wrap gap-6 p-10 justify-center bg-gray-100">
      {data?.map((item, index) => (
        <Link
          href = {item.hrefs[0] || ""}
          key={index}
          className="w-56 bg-white shadow-md rounded-2xl p-4 flex flex-col items-center"
        >
          <img
